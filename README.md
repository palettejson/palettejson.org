...
This repository hosts the documentation for [PaletteJSON](https://palettejson.org), a portable JSON container format for colour palettes.

## About PaletteJSON

PaletteJSON is a specification for sharing and storing colour palettes in a structured, interoperable way.  
It aims to be a bridge format — a lingua franca for colour — that can work across tools, languages, and design systems.
