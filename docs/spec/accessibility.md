...
sidebar_position: 6
description: Describes how to record colour-vision-deficiency testing and other accessibility metadata at the palette level.
---

# Accessibility

PaletteJSON allows palettes to include an `accessibility` object.  
This metadata records testing and notes related to colour-vision deficiency (CVD) and perceptual distinctiveness.
...
Purpose: declare which colour-vision deficiencies have been explicitly tested for this palette.
...
Purpose: indicate the maximum number of classes (distinct colours) that remain distinguishable under a given CVD condition.
