...
<Tabs>
  ...
  Demonstrates named colours with hex values only.
...
```
  ...
  Demonstrates a rich palette with IDs, metadata, and both hex and component values for each colour.
...
Next: return to the [Specification](./spec/file-format.md) or explore other parts of the docs.
